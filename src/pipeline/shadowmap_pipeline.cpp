...
PipelineShadowMap::PipelineShadowMap(std::shared_ptr<Device> device,
...
PipelineShadowMap::~PipelineShadowMap() { }

void PipelineShadowMap::createPipeline(const ShaderCodePaths& paths)
{
