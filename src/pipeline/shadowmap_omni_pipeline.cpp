#include "shadowmap_omni_pipeline.h"

namespace engine
{

PipelineShadowMapOmni::PipelineShadowMapOmni(std::shared_ptr<Device> device,
...
PipelineShadowMapOmni::~PipelineShadowMapOmni() { }

void PipelineShadowMapOmni::createPipeline(const ShaderCodePaths& paths)
{
